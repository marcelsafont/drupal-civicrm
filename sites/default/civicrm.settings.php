...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupal7:drupal7@database/drupal7?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests') {
    ...
    define('CIVICRM_DSN', 'mysql://drupal7:drupal7@database/drupal7?new_link=true');
  }
}
...
$civicrm_root = '/app/sites/all/modules/civicrm/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/app/sites/default/files/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://drupal-civicrm.lndo.site');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'zPHrBNQ5RSuixyWQ5V0piPVyx9VD5tEVA1RFzaXsBk');
}
...
if (!defined('CIVICRM_CRED_KEYS') ) {
  define( '_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:jYKQvtKSXams3SivrA3mCJWMExaNaEQMRFEEGFB8C4dsE3Ig');
...
if (!defined('CIVICRM_SIGN_KEYS') ) {
  define( '_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:4inqT1pH7cLXoTeZGPHeu7Og6iMFZRn3qHbJdPpK8HDmnGHxcgDnQ');
...
// define( 'CIVICRM_MAIL_LOG', '/app/sites/default/files/civicrm/templates_c/mail.log');
// }
